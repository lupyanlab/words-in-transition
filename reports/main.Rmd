...
grid.newpage()
read_chunk_fig("true-seed", y = 0.8, width = 0.8)
read_chunk_fig("category-match", y = 0.5, width = 0.8)
read_chunk_fig("specific-match", y = 0.2, width = 0.8)
```
...
```{r 5-match-transcription-to-seed-mod}
```

```{r 5-match-transcription-to-seed-plot, fig.show = "hide"}
```
